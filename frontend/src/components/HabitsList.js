...
import SyncHabitToCalendarButton from "./SyncHabitToCalendarButton"
import ReminderConfigButton from "./ReminderConfigButton" // agregando componente de recordatorios
              ...
              {editingHabit === habit._id ? (
                ...
                <>
                  ...
                  <div className="habit-actions">
                    ...
                    <SyncHabitToCalendarButton habitId={habit._id} habitTitle={habit.title} />
                    <ReminderConfigButton
                      habitId={habit._id}
                      habitTitle={habit.title}
                      currentReminder={habit.reminder}
                    />
